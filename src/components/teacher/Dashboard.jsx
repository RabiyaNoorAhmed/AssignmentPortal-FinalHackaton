...
import { deepPurple, teal, amber, pink, red, blue } from '@mui/material/colors';
...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        // Fetch student count based on course and batch
        if (selectedCourse && selectedBatch) {
          ...
          // Fetch total assignments based on course and batch
